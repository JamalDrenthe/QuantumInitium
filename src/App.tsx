...
export function App() {
  ...
  const [show3dCards, setShow3dCards] = useState<boolean>(false);
        ...
        <div className="max-w-7xl mx-auto flex w-full flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex w-full min-w-0 flex-nowrap items-center justify-start gap-1 overflow-x-auto sm:gap-2.5 md:w-auto md:justify-end">
            ...
            <button
              ...
              className={`max-md:px-2 max-md:py-1 px-2.5 py-1.5 rounded-xl border transition-all flex items-center gap-1.5 cursor-pointer text-xs font-mono font-bold shadow-sm shrink-0 ${
                theme === 'light'
            ...
            {sidebarView === 'entities' && (
              <>
                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-3">
                  ...
                  {false && (entityCategoryFilter === 'all' || entityCategoryFilter === 'subholdings') && filteredSubholdings.length > 0 && (
                    <div className="space-y-2">
